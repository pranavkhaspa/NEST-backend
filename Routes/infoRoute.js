    ...
    const apiInfo = {
        ...
        endpoints: {
            auth: {
                ...
                methods: {
                    "POST /": {
                        description: "Authenticate a user via Auth0 JWT and create a local user record if one doesn't exist.",
                        input: "Auth0 JWT (passed in the Authorization header as a Bearer token)",
